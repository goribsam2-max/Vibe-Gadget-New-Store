        ...
        <AnimatePresence>
          {toasts.map((toast) => (
            <motion.div
              ...
              className={`pointer-events-auto px-4 py-2.5 rounded-full shadow-lg flex items-center space-x-2 border backdrop-blur-md ${
          ...
          <div className="fixed inset-0 z-[10000] flex items-center justify-center p-6">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.9, y: 10 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.9 }} className="bg-zinc-50 dark:bg-zinc-800 rounded-2xl p-8 w-full max-w-sm shadow-sm relative z-10 text-center border border-zinc-100 dark:border-zinc-800">
              ...
              <div className="flex flex-col gap-2">
                ...
                <button onClick={() => setConfirmModal(null)} className="w-full py-4 text-zinc-400 font-bold text-[10px]  tracking-normal">
                  Cancel
                </button>
              </div>
            </motion.div>
