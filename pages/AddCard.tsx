  ...
  return (
    <div className="p-6 pb-24 animate-fade-in min-h-screen">
      <div className="flex items-center space-x-4 mb-8">
        <button
          onClick={() => navigate(-1)}
          className="p-2 bg-[#f4f4f5] dark:bg-zinc-800/80 rounded-2xl"
        >
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center space-x-2">
          <input
            ...
            defaultChecked
          />
          <label htmlFor="save" className="text-xs font-bold">
            Save Card
          </label>
        </div>
      </div>

      <button onClick={() => navigate(-1)} className="btn-primary w-full mt-10">
        Add Card
      </button>
    </div>
  );
