    ...
    <div className="p-6 md:p-12 pb-24 animate-fade-in bg-zinc-50 dark:bg-zinc-800 max-w-xl mx-auto min-h-screen font-inter">
      ...
      <div className="flex items-center space-x-6 mb-12">
        <button
          ...
          className="p-3.5 bg-zinc-50 dark:bg-zinc-800 rounded-2xl hover:bg-zinc-900 hover:text-white transition-all shadow-sm"
        >
      ...
      <div className="flex-1">
        <p className="text-zinc-600 dark:text-zinc-400 text-sm mb-10 leading-relaxed font-medium">
          ...
          <strong className="text-black dark:text-white">{email}</strong>. It
      ...
      <button
        disabled={loading}
        onClick={handleReset}
        className="btn-primary w-full py-4 shadow-sm shadow-zinc-200 mt-12 disabled:opacity-50 flex items-center justify-center text-sm"
      >
