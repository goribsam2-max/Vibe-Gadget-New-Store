  ...
  return (
    <div className="p-6 pb-24 animate-fade-in min-h-screen bg-zinc-50 dark:bg-zinc-800 max-w-md mx-auto print:p-0">
      <div className="flex items-center space-x-6 mb-10 print:hidden">
        <button
          onClick={() => navigate(-1)}
          className="p-3 bg-zinc-50 dark:bg-zinc-800 rounded-2xl active:scale-95 transition-transform border border-zinc-100 dark:border-zinc-800 shadow-sm"
        >
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[9px] text-zinc-400 font-bold">
                  Qty: {item.quantity}{" "}
                  {order.isGift ? "" : `× ৳${item.priceAtPurchase}`}
                </p>
              </div>
      ...
      <button
        ...
        className="w-full mt-10 py-5 bg-primary-500 text-white rounded-full flex items-center justify-center space-x-3 text-[10px] font-semibold  tracking-normal print:hidden shadow-lg active:scale-[0.98] transition-all disabled:opacity-50"
      >
        {downloading ? (
