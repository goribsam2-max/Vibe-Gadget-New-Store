          ...
          >
            <div className="flex justify-between items-start mb-6">
              <div className="flex items-center space-x-4">
                <img
                  ...
                  className="w-12 h-12 rounded-full border-2 border-zinc-100 dark:border-zinc-800"
                  alt=""
                />
                <div>
                  <p className="font-semibold text-sm tracking-tight text-zinc-900 dark:text-zinc-100 truncate max-w-[140px]">
                    {user.displayName}
                  </p>
              ...
              <div className="flex items-center space-x-2">
                <span
                  className={`px-2 py-0.5 rounded text-[8px] font-bold  tracking-normal ${user.role === "admin" ? "bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900" : "bg-zinc-100 text-zinc-500 dark:bg-zinc-800"}`}
                >
                  {user.role}
                </span>
                <div
                  className={`w-2 h-2 rounded-full ${user.isBanned ? "bg-white border-2 border-red-500" : "bg-green-500"}`}
                ></div>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex justify-between items-center text-[10px] font-medium text-zinc-500">
                ...
                <code className="text-zinc-900 dark:text-zinc-300">
            ...
            <div className="flex items-center space-x-2 border-t border-zinc-100 dark:border-zinc-800 pt-4">
              <button
                ...
                className="flex-1 py-2 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 text-zinc-900 dark:text-zinc-100 rounded-lg text-[10px] font-bold  tracking-normal transition-colors"
              >
                Profile
              </button>
              <button
              ...
              >
                <Icon
                  name={user.isBanned ? "unlock" : "user-slash"}
                  className="text-xs"
                />
              </button>
            </div>
