  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10 pb-32 min-h-screen bg-zinc-50 dark:bg-zinc-800/50">
      <div className="flex items-center justify-between mb-12">
        ...
        >
          <Icon name={showAddForm ? "times" : "plus"} className="mr-2" />{" "}
      ...
      {showAddForm && (
        <motion.div
          ...
          className="bg-zinc-50 dark:bg-zinc-800 p-8 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-700 mb-8"
        >
          ...
          >
            ...
            <div>
              ...
              <div className="flex space-x-2">
                ...
                <select
                  ...
                  className="p-4 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-2xl text-sm font-bold  tracking-normal cursor-pointer"
                >
            ...
            <div className="flex items-end">
              <button
                type="submit"
                className="w-full p-4 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 text-white rounded-2xl font-bold  tracking-normal text-xs hover:bg-emerald-600 transition-colors shadow-lg shadow-emerald-500/20"
              >
                Create Promo
              </button>
            </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {coupons.map((coupon) => (
            <div
              key={coupon.id}
              className="bg-zinc-50 dark:bg-zinc-800 p-6 rounded-2xl border border-zinc-200 dark:border-zinc-700 shadow-sm relative group overflow-hidden"
            >
              <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-emerald-400 to-emerald-600"></div>
              <div className="flex justify-between items-start mb-6 mt-2">
                <div className="bg-zinc-50 dark:bg-zinc-900 text-emerald-700 px-4 py-2 rounded-lg font-semibold tracking-normal border border-zinc-200 flex items-center">
          ...
          {coupons.length === 0 && (
            <div className="col-span-full py-20 text-center bg-zinc-50 dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 shadow-sm text-zinc-400">
