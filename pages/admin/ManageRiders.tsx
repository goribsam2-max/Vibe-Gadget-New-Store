    ...
    <div className="max-w-6xl mx-auto px-6 py-10 pb-32 min-h-screen bg-zinc-50 dark:bg-zinc-800/50">
        ...
        >
          ...
          <form onSubmit={handleAddRider} className="space-y-6">
            ...
            <div className="flex justify-end pt-4">
              <button
                type="submit"
                className="px-8 py-3 bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 text-white rounded-full font-bold  tracking-normal text-xs hover:bg-emerald-600 transition-colors shadow-lg shadow-emerald-500/20"
              >
                Register Rider
              </button>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {riders.map((rider) => (
          <div
            key={rider.id}
            className="bg-zinc-50 dark:bg-zinc-800 p-6 rounded-2xl border border-zinc-200 dark:border-zinc-700 shadow-sm relative overflow-hidden group"
          >
            ...
            <div className="flex justify-between items-start mb-6 mt-1">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-zinc-400 font-bold  tracking-normal">
                    {rider.phone}
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 border-t border-zinc-100 dark:border-zinc-800 pt-5">
              <div>
                ...
                <p className="font-bold text-zinc-800 dark:text-zinc-200 text-sm mt-1 flex items-center">
                  <Icon
                    name="map-marker-alt"
                    className="text-zinc-900 dark:text-zinc-100 mr-2 text-[10px]"
                  />
                  {rider.zone}
                </p>
              </div>
              <div>
                ...
                <div className="flex items-center space-x-2 mt-1">
                  ...
                  <span className="font-bold text-zinc-800 dark:text-zinc-200 text-sm">
                    {rider.status} ({rider.deliveriesCompleted || 0} Trips)
                  </span>
                </div>
              </div>
            </div>
