            ...
            <AnimatePresence>
              {reviews.map((review) => (
                <motion.div
                  ...
                  className="border border-zinc-200 dark:border-zinc-800 p-6 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-6 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors"
                >
                  <div className="flex-1">
                    <div className="flex items-center mb-2 gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-2 text-[10px]  font-bold text-zinc-400 tracking-normal">
                    ...
                    {review.comment && (
                      <p className="text-sm text-zinc-600 dark:text-zinc-400 ml-12 italic leading-relaxed">
                        "{review.comment}"
                      </p>
                    )}
                    {review.images && review.images.length > 0 && (
                      <div className="flex gap-2 mt-4 ml-12">
                        {review.images.map((img, i) => (
                          <div
                            key={i}
                            className="w-16 h-16 rounded-full border border-zinc-200 dark:border-zinc-700 overflow-hidden"
                          >
                            <img
                              src={img}
                              className="w-full h-full object-cover"
                    ...
                    <div className="ml-12 mt-3">
                      <span className="text-[9px]  font-bold tracking-normal text-zinc-900 dark:text-zinc-100 bg-zinc-50 dark:bg-zinc-900 dark:bg-emerald-900/30 px-2 py-1 rounded-md">
                  ...
                  <button
                    ...
                    className="px-5 py-3 h-max shrink-0 bg-red-50 hover:bg-red-100 dark:bg-red-900/10 dark:hover:bg-red-900/30 text-red-600 rounded-2xl font-bold text-[10px]  tracking-normal transition-colors flex items-center justify-center gap-2"
                  >
                    <Icon name="trash" />
                    <span>Delete</span>
                  </button>
