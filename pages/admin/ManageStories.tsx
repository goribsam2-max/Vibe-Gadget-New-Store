      ...
      <div className="max-w-3xl mx-auto px-6 py-10 pb-48 min-h-screen bg-zinc-50 dark:bg-zinc-800 font-inter">
        <div className="flex items-center space-x-6 mb-12">
          <button
            ...
            className="p-3 bg-zinc-100 dark:bg-zinc-800 rounded-2xl hover:bg-zinc-900 hover:text-white transition-all"
          >
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex bg-zinc-100 dark:bg-zinc-800 p-1.5 rounded-full">
              <button
                ...
                className={`flex-1 py-3 text-sm font-bold rounded-full transition-all ${type === "image" ? "bg-zinc-50 dark:bg-zinc-800 shadow border border-zinc-200 dark:border-zinc-700" : "text-zinc-500 hover:bg-zinc-200"}`}
              >
                Image Cover
              </button>
              <button
                onClick={() => setType("video")}
                className={`flex-1 py-3 text-sm font-bold rounded-full transition-all ${type === "video" ? "bg-zinc-50 dark:bg-zinc-800 shadow border border-zinc-200 dark:border-zinc-700" : "text-zinc-500 hover:bg-zinc-200"}`}
              >
                Direct Video Link
              </button>
            </div>
          ...
          {type === "image" ? (
            <div>
              ...
              <div
                ...
                className="h-48 border-2 border-solid border-zinc-300 rounded-full flex flex-col items-center justify-center cursor-pointer hover:bg-zinc-50 dark:bg-zinc-800 transition-colors relative overflow-hidden group"
              >
                {loading && !previewUrl ? (
                  <Icon
                    name="spinner"
                    className="animate-spin text-zinc-400 text-xl"
                  />
                ) : previewUrl ? (
                  <img
                    src={previewUrl}
          ...
          <div className="bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 p-6 rounded-2xl space-y-5">
            <div className="flex items-center justify-between">
              ...
              <div className="flex border border-zinc-200 dark:border-zinc-700 rounded-lg overflow-hidden text-[10px] font-bold">
                <button
                  ...
                  className={`px-3 py-1.5 ${songSource === "preset" ? "bg-zinc-900 text-white" : "bg-zinc-50 dark:bg-zinc-800 text-zinc-500"}`}
                >
                  Presets
                </button>
                <button
                  onClick={() => setSongSource("custom")}
                  className={`px-3 py-1.5 ${songSource === "custom" ? "bg-zinc-900 text-white" : "bg-zinc-50 dark:bg-zinc-800 text-zinc-500"}`}
                >
                  Custom Link
                </button>
              </div>
            ...
            {songSource === "preset" ? (
              <select
                className="w-full bg-zinc-50 dark:bg-zinc-800 p-4 rounded-2xl border border-zinc-200 dark:border-zinc-700 text-sm font-bold outline-none"
              ...
              <input
                ...
                placeholder="https://yourserver.com/song.mp3"
            ...
            {finalAudioPreviewUrl && (
              <div>
                <label className="text-[10px] font-bold text-zinc-400  mb-2 block">
                ...
                <input
                  ...
                  className="w-full bg-zinc-50 dark:bg-zinc-800 p-4 rounded-2xl border border-zinc-200 dark:border-zinc-700 text-sm font-bold outline-none focus:border-black"
                />
                ...
                <div className="mt-4 flex items-center space-x-3 bg-zinc-50 dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-800 p-3 rounded-2xl shadow-sm">
                  ...
                  <button
                    ...
                    className="flex-1 text-xs font-bold  bg-zinc-900 dark:bg-zinc-100 text-white px-4 py-3 rounded-xl active:scale-95 transition-all"
                  >
                    Preview 5s Sync
                  </button>
                  <button
          ...
          <div className="pt-4 pb-12">
            <button
              onClick={handleSave}
              disabled={loading}
              className="w-full py-5 bg-primary-500 text-white rounded-full font-bold  tracking-normal text-sm hover:opacity-90 active:scale-[0.98] transition-all disabled:opacity-50 shadow-sm shadow-black/20"
            >
    ...
    <div className="max-w-6xl mx-auto px-6 py-10 pb-48 min-h-screen bg-zinc-50 dark:bg-zinc-800 font-inter">
      <div className="mb-12 flex items-center justify-between">
        ...
        <button
          ...
          className="bg-zinc-900 dark:bg-zinc-100 text-white px-5 py-3 rounded-full font-bold text-xs  tracking-normal shadow-lg hover:bg-zinc-900 transition-colors flex items-center space-x-2"
        >
          <Icon name="plus" />
          <span>Add Story</span>
        </button>
