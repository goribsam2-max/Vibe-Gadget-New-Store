    ...
    <div className="max-w-7xl mx-auto px-6 py-10 bg-zinc-50 dark:bg-zinc-800 min-h-screen pb-32">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-1">
          <form
            onSubmit={handleAdd}
            className="bg-zinc-50 dark:bg-zinc-800 p-10 rounded-2xl border border-zinc-100 dark:border-zinc-800 space-y-8 shadow-sm sticky top-10"
          >
            <h2 className="text-xs font-semibold  tracking-normal text-zinc-400 mb-4">
              {editingId ? "Edit" : "Create New"} Banner
            </h2>

            <div>
              <label className="block text-[10px] font-bold text-zinc-400  mb-3 px-1">
                Main Title
              </label>
              <input
                type="text"
            ...
            <div>
              ...
              <input
                ...
                type="file"
                accept="image/*"
                className="w-full bg-zinc-50 dark:bg-zinc-800 p-5 rounded-2xl outline-none text-[10px] font-bold  shadow-inner cursor-pointer"
                onChange={(e) =>
                  setFormData({
                    ...formData,
            ...
            <button
              disabled={uploading}
              className="w-full bg-zinc-900 border border-zinc-900 text-white shadow-sm disabled:opacity-50 text-[10px] font-bold  tracking-normal py-4 rounded-full transition-all hover:bg-zinc-900"
            >
              {uploading
                ? "Uploading..."
                : editingId
            ...
            {editingId && (
              <button
                ...
                className="w-full text-[10px] font-semibold  text-zinc-400 tracking-normal mt-2 hover:text-black dark:text-white transition-colors"
              >
                Cancel Editing
              </button>
            )}
