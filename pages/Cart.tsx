              ...
              <div className="sticky top-24">
                <Card className="rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-sm bg-white dark:bg-zinc-900 overflow-hidden">
                  ...
                  <CardFooter className="pt-2 pb-6">
                    <Button
                      size="xl"
                      className="w-full rounded-2xl shadow-lg shadow-emerald-500/20 bg-emerald-500 hover:bg-emerald-600 border-none text-white dark:text-white dark:bg-emerald-500 font-bold tracking-wide"
